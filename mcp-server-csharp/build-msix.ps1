...
& "..\tools\winsdk-win-x64\winsdk.exe" cert generate --manifest "msix\appxmanifest.xml" --if-exists skip

# Package the MSIX
Write-Host "Packaging MSIX..." -ForegroundColor Yellow
& "..\tools\winsdk-win-x64\winsdk.exe" package ".\msix" --cert ".\devcert.pfx"
if ($LASTEXITCODE -ne 0) {
