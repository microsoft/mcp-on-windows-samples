...
# Step 3: Copy files to server directory
Write-Host "Step 3: Copying executable to mcpb server directory..." -ForegroundColor Yellow
...
Write-Host "Step 4: Packing the MCP bundle..." -ForegroundColor Yellow
